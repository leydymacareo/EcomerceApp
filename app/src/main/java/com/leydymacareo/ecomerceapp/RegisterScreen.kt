...
import com.leydymacareo.ecomerceapp.validateConfirmPassword
import com.leydymacareo.ecomerceapp.validateEmail
import com.leydymacareo.ecomerceapp.validateName
                    ...
                    auth.createUserWithEmailAndPassword(inputEmail, inputPassword).
                            addOnCompleteListener { task ->
                                if (task.isSuccessful) {
                                    ...
                                    registerError = when (val exception = task.exception) {
                                        is FirebaseAuthInvalidUserException -> "Correo inválido"
